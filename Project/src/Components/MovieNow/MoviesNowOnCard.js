...
function Main() {
  ...
  const categories = [
    { id: 1, name: 'Top Đánh Giá', data: 'top_rated', className: "type-move-choose" },
    { id: 2, name: 'Sắp Chiếu', data: 'upcoming', className: "type-move-choose" },
    { id: 3, name: 'Phổ Biến', data: 'popular', className: "type-move-choose" },
    { id: 4, name: 'Đang Chiếu', data: 'now_playing', className: "type-move-choose" }
  ]
    ...
    <div className="movie-for-today">
      <ul className="typeMovie" >
        {categories.map((index) => (
          <li key={index.name} onClick={() => handleIndex(index.id)}
      ...
      <div className="list-movie-for-today">{Movies}{loader}</div>
